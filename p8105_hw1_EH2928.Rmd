...
```
##Create code chunk for converting variable types, propmt asks for all numeric conversions, then different conversions for different variables.
...
```
##Assignment deliverables for variable type conversion and manipulation

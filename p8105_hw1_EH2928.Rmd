...
```
This is a dataset with with 344 observations of 8 variables, and describes 3 species of penguins on 3 different islands; there are measurements on bill length and depth, flipper length, body mass, sex, and year, though there are missing data. 
